                ...
                <table id="example" style="width:100%">
                    ...
                    @foreach ($materias as $materia)
                        <tr>
                            ...
                            <th scope="col"> {{ $materia['anio'] }} </th>
                            <th scope="col"> {{ $materia['cuatrimestre'] }} </th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn red lighten-1 ml-2 btn-small"
                                            ...
                                            data-name="{{$materia['nombre']}}" data-id="{{$materia['id']}}">Borrar
                                    </button>
                                </div>
                            </td>
                            @endif
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="alert alert-warning" role="alert">
                                <p>Esta seguro de borrar la materia <b id="name">{{ $materia['nombre'] }}</b> ?</p>
                            </div>
